...
torch::Tensor simulate_magnetization_libtorch(
    torch::Tensor rf,
    torch::Tensor freq,
    torch::Tensor b1,
    float dt
)
{
    ...
    torch::Tensor mxyz = torch::stack({mx, my, mz}, 0);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("simulate_magnetization_libtorch", &simulate_magnetization_libtorch, "full x, y, and z magnetization simulation in response to RF pulse");
}
